...
class ScoreBoard extends React.Component {
  ...
  componentDidUpdate() {
    ...
    const update = this.dispatch(cmd); //get foo
    this.props.clr(); // prevent recursion
    update();
  }
  ...
  rotate = () => this.persist(baseball.toggleBatting(this.state.scoreboard));
  whoIsBatting = () =>
    this.state.scoreboard.batting === "awayTeam"
      ? this.state.scoreboard.teams.awayTeam
      : this.state.scoreboard.teams.homeTeam;
